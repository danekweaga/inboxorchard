...
function FlowBuilder({ initial, automationId: initialId, onClose, notify }: { initial: AutomationDefinition; automationId?: string; onClose: () => void; notify: Notify }) {
  ...
  const [builderMode, setBuilderMode] = useState<"simple" | "advanced">(() =>
    ["instagram_comment", "instagram_dm", "keyword", "story_reply", "story_mention"].includes(initial.trigger.type) ? "simple" : "advanced",
  );
